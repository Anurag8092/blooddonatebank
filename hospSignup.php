...
if(isset($_POST["submit"])){
    ...
    $emailquery = "select * from hospitalreg where email='$email' ";
    ...
    if($emailcount > 0){
        echo "email already exist";
            ...
            $insertquery = "insert into hospitalreg(hospitalname, email, password) values('$hospitalname', '$email', '$pass')";
...
<div class="card">
  <div class="card-body">
  <h5 class="card-title">Create a Hospital Account</h5>
  <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
  <div class="form-group">
  <input name="hospitalname" type="text" class="form-control" id="nameInput" aria-describedby="nameHelp" placeholder="Enter Name" required
  >
  ...
  <div>Already have an Account?  <a href="hospLogin.php">Login</a> </div>
