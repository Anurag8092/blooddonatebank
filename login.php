...
if(isset($_POST["submit"])){
  ...
  $email_search = "select * from receiverreg where email='$email' ";
  ...
  if($email_count){
    ...
    $_SESSION["name"] = $email_pass["name"];  // store the name corresponding to the password
...
<div class="card">
  <div class="card-body">
  <h5 class="card-title">Log In As Receiver</h5>
